...
| **NLP** | **LLMs** |
| --- | --- |
| Earlier NLP models were Designed for specific tasks like Language Translation  | Can do a wide range of tasks due to [emergent properties] |
<center>
<iframe width="350" height="215" src="https://www.youtube.com/embed/WjhDDeZ7DvM?si=Cj4EVnYaAaz08W2T" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</center>
